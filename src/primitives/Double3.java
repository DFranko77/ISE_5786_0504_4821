...
public record Double3(double _d1, double _d2, double _d3) {
    ...
    /**
     * Logical negation of isLowerThan according to De Morgan's laws.
     * Returns true when at least one component is greater than or equal to the
     * corresponding component in {@code other}.
     */
    public boolean isGreaterThan(Double3 other) { return !isLowerThan(other); }

    /**
     * Logical negation of isLowerThan for scalar comparison.
     * Returns true when at least one component is greater than or equal to {@code k}.
     */
    public boolean isGreaterThan(double k) { return !isLowerThan(k); }
}
