...
class TubeTests {
    ...
    void testFindIntersections() {
        ...
        Tube tube = new Tube(1d, new Ray(new Point(2, 2, 2), Vector.AXIS_Z));

        // ============ EP: Equivalence Partitions Tests ============
        assertAll("EP (" + epTestCases + " cases)",
                () -> {
                    // TC EP01: Ray line is outside the tube. No intersections are expected.
                    Ray ray = new Ray(new Point(0, 4, 2), Vector.AXIS_X);
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(0, 2.5, 2), Vector.AXIS_X);
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(1.5, 2.5, 2), Vector.AXIS_X);
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(4, 2.5, 2), Vector.AXIS_X);
                    assertNull(tube.findIntersections(ray),
        ...
        assertAll("BVA (" + bvTestCases + " cases)",
                () -> {
                    ...
                    Ray ray = new Ray(new Point(2 - offset, 2.5, 2), Vector.AXIS_X);
                    assertEquals(List.of(new Point(2 + offset, 2.5, 2)), tube.findIntersections(ray),
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(0, 2, 2), Vector.AXIS_X);
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(3, 2, 2), Vector.AXIS_X);
                    assertNull(tube.findIntersections(ray),
                ...
                () -> {
                    ...
                    Ray ray = new Ray(new Point(4, 3, 2), Vector.AXIS_X);
                    assertNull(tube.findIntersections(ray),
